...
<div class="wrapper"style="background-color:#212529;">
  ...
  <div class="content-wrapper"font-family: 'Montserrat';font-size: 22px;>
    <!-- Content Header (Page header) -->
    <div class="content-header"style="background-color:#212529;"font-family: 'Montserrat';font-size: 22px;>
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark text-light"><span class="text-light"font-family: 'Montserrat';font-size: 22px;>Salon Calendar</span> </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card"style="background-color:#212529;">
               ...
               <div class="card-body p-0">
                    ...
                    <div class="row text-center">
                                    ...
                                    <h5 class="text-info px-3">Today Appointments : <?php echo $count; ?> </h5>
{{--                        @php $todo=\App\Todo::all();--}}
{{--                        @endphp--}}
                        @php($key = 1);
                        @foreach($dateWishCustomers as $customer)
                                <div class="col-md-12">
                                    <div class="info-box" style="background-color:{{$customer->color_code}}">
                                        <div class="info-box-content">
    
                                            <div class="progress"></div>
                                            
                                                <a href="{{ url('/admin/all/customers/'.$customer->date) }}" class="text-white">
                                                <h5 class="info-box-number">{{$customer['date']}}</h5>
                                                <h4 class="info-box-number">{{$customer['time']}}</h3>
                                                <span class="info-box-number">{{$customer['first_name'] . ' '.  $customer['last_name']}}</span>
                                                <span class="info-box-number">{{$customer['email']}}</span>
                                                <span class="info-box-number">{{$customer['phone']}}</span>
                                                </a>
                                                <button type="button" class="btn btn-primary btn-sm my-2 viewData" id="{{$customer->id}}" data-toggle="modal" data-target="#customerView"style="border-radius: 50px;">Show Details <i class="fas fa-arrow-right ml-1"></i></button>
      ...
      <!-- Modal  Customer Details -->
        <div class="modal fade" id="customerView" data-target="#exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="model m" style="background-color:#212529; " id="model-show">
        ...
        <div class="class="form-inline"">
            <form class="form-inline" action="{{url('admin/customer/search-customer')}}" method="post">
                @csrf
               <input style="background-color: black;color:white; border:none;" class="form-inline in" type="text" name="search_customer"  placeholder="existing customer is choose for new appointment" required value="">
               
                
                <button style="background-color:#CACFD2; " class="" type="submit">
            <i class="fa fa-search"></i>
          </button>
            </form>
        ...
        &nbsp;&nbsp;
            ...
            <section>
  <section class="row justify-content-center modal-body"  id="exampleModalCenter" style="font-family: 'Montserrat', 'sans-serif';">
    <section class="col-md-10 col-sm-12 col-12 col-lg-10 m">
      <form class="" action="{{route('admin.customer.store-customer')}}" method="post">
        @csrf
        <div class="row"><!--customer infor form star-->
          <legend class="text-light font-weight-bold h5" style="font-family: 'Montserrat', 'sans-serif';">CUSTOMER INFO</legend>
        ...
        <div class="row"><!--customer socilite start -->
          <legend class="text-light font-weight-bold h5" style="font-family: 'Montserrat', 'sans-serif';">CUSTOMER SOCIALITE INFO</legend>
          <div class="col-md-4 col-sm-12 col-lg-4 col-12">
            <label class="h6 text-light" for=""> Email</label>
          ...
          <div class="col-md-4 col-sm-12 col-lg-4 col-12">
            <label class="h6 text-light" for=""> Whatsapp</label>
          ...
          <div class="col-md-4 col-sm-12 col-lg-4 col-12">
            <label class="h6 text-light" for=""> Facebook</label>
        ...
        <div class="row"><!--customer schdule start -->
          <legend class="text-light font-weight-bold h5" style="font-family: 'Montserrat', 'sans-serif';">CUSTOMER SCHEDULE INFO</legend>
          <div class="col-md-4 col-sm-12 col-lg-4 col-12">
        ...
        <hr>
         <div class="row"><!--customer schdule Date -->
          <legend class="text-light font-weight-bold h5" style="font-family: 'Montserrat', 'sans-serif';">CUSTOMER REMINDER DATE</legend>
        ...
        <div class="float-right mt-3">
          ...
          <a class="btn btn-danger" href="#" id="model-close" onclick="model_close()">Close</a>
        </div>
      </form>
    </section>
  </section>
   ...
   var funvalue; 
    ...
    $(function() {
      $('#calendar').fullCalendar({
        ...
        viewRender: function(date, view, element,callback) {
          $.ajax({
            ...
            success: function(data) {
                $("#calendar").fullCalendar( 'refetchEvents' );
                  for(var i=0; i<data.length; i++){
                    title=data[i].views;
                    date=data[i].date;
                    //  $('fc-title').html(' <span class="customer-hidden">Customer</span>');
